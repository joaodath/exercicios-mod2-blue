...
btnMoodDoctor.onclick = function () {
    if (btnMoodDoctor.value === 'happy1') {
        ...
        moodDoctor.textContent = 'The Doctor is curious!';
        ...
        moodDoctor.textContent = 'The Doctor is sad!';
        ...
        moodDoctor.textContent = 'The Doctor is happy!';
        ...
        moodDoctor.textContent = 'The Doctor is naughty!';
        ...
        moodDoctor.textContent = 'The Doctor is angry!';
